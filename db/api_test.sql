...
CREATE TABLE `api_assert`  (
  ...
  `assert_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '断言名称',
  `assert_item` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '断言项',
...
CREATE TABLE `api_extractor`  (
  ...
  `extractor_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提取器表达式${abc}',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `api_info`  (
  ...
  `protocol` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '接口协议',
  `server` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务地址',
...
CREATE TABLE `project_variable`  (
  ...
  `aid` int(11) NULL DEFAULT NULL COMMENT '0:项目配置，>0关联api_info表id列',
  ...
  INDEX `fk_var_api`(`aid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
