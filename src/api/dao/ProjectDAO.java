...
public class ProjectDAO extends BaseDAO{
	...
	public boolean add(Project bean) {
		...
		Object[] params = {bean.getName(), bean.getSign(), bean.getEncrypt(), bean.getUser().getId(), DateUtil.d2t(new Date()), bean.getComments()};
	...
	public boolean update(Project bean) {
		String sql = "update project_info set name = ? ,sign = ?,encrypt = ?, comments=? where id=?";
		Object[] params = {bean.getName(), bean.getSign(), bean.getEncrypt(), bean.getComments(), bean.getId()};
		return super.update(sql, params);
	}
