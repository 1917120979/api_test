...
public class SignAndEncriptUtil {
	private static final Logger logger = LoggerFactory.getLogger(SignAndEncriptUtil.class);
	...
	public static String getPostGatewayResponse(String url, Map<String, String> header,String requestData,String appsecret) {
		...
		String result = HttpClientUtil.doPostJson(url, requestData, header);
