...
<div id="page-wrapper">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li><i class="ace-icon fa fa-home home-icon"></i> <a href="index.jsp">首页</a>
			</li>
	...
	<div class="row">
		...
		<div id="addProjectDiv" class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="" id="addProjectForm" name="admin_project_add" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="button" class="btn btn-primary" onclick="submitProject()">提交</button>
